...
public class DP3TCryptoModule {
  ...
  // Get ephIDString
  public static var getCurrentEphIDString: String {
    get {
      let current = try! DP3TCryptoModule().getCurrentEphID()
      return current.hexEncodedString.replacingOccurrences(of: " ", with: "").uppercased()
    }
  }
